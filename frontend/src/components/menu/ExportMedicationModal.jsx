...
export default function ExportMedicationModal({ onClose }) {
  ...
  const handleExport = async () => {
    ...
    try {
      ...
      link.setAttribute('download', `medication_log_${startDate}_to_${endDate}.${ext}`);
  ...
  return (
    <div className="modal-overlay">
      <div className="modal-box" style={{textAlign: 'left', minWidth: '350px'}}>
        <h3 style={{marginTop: 0, marginBottom: '20px'}}>Export Medication Log</h3>
        ...
        <div className="modal-actions" style={{justifyContent: 'flex-end', gap: '10px', marginTop: '25px'}}>
